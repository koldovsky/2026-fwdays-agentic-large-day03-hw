...
- [x] 3.3 Ensure hit testing composes with zoom, scroll, rotation, and element ordering; add integration or e2e coverage where the repo already tests pointer routing
...
- [x] 5.2 Manual QA matrix: light/dark theme, long URLs, wrapped lines, export/open in new tab, blocked popup behavior
