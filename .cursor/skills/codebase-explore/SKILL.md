...
description: Read-only exploration of unfamiliar code—maps directories, responsibilities, data flow, and cross-package dependencies. Use when the user asks to explore, investigate, or how something works in the codebase.
---
